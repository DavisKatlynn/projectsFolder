...
//  mathGame2
//
//  Created by Katlynn Davis on 1/28/23.
//
...
struct ContentView: View {
    ...
    @State private var title = "Multiplication Game"
...
//                        }
                ...
                VStack {
                    ...
                    Picker("Choose Times Table to Work on", selection: $multiplicationChoice) {
                    ...
                    .background(
                        LinearGradient(gradient: Gradient(colors: [Color(.magenta), Color(.systemPink), Color(.systemTeal)]), startPoint: .top, endPoint: .bottom)
                    )
                    .clipShape(Circle())
                    .font(.system(size: 50))
                    .border(.blue)
